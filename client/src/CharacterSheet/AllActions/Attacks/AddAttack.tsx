...
const AddAttack: React.FC<IProps> = ({handleClose}) => {
  ...
  return (
    <form className="form-atk" onSubmit={onSubmit}>
      ...
      <label className="form-atk__box-label">Proficiency<input ref={register} className="form-atk__checkbox" type="checkbox"
                                                               name="proficient"/></label>
      ...
      <select className="form-atk__input" ref={register} name="type">
        ...
        <option value="Bluegoing">Bludgeoning</option>
